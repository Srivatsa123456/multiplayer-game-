...
rank
        ...
        camera.position.y=0
        imageMode(CENTER)
        image(goldimg,displayWidth/2,displayHeight/2,50,50)
        image(silverimg,displayWidth/2+50,displayHeight/2+50,50,50)
        image(bronzeimg,displayWidth/2-50,displayHeight/2+50,50,50)
        
        textAlign(CENTER); 
        textSize(50); for(var plr in allPlayers){ 
